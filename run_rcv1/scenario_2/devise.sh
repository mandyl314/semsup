...
OUTPUT_DIR=./model_outputs/devise
...
# Files being used
TRAIN_FILE=../rcv1/rcv1_all_stratified_heldout_75_42.json
VALIDATION_FILE=../rcv1/rcv1_val.json
TEST_FILE=../rcv1/rcv1_test.json

TRAIN_DESCRIPTIONS=../../class_descrs/rcv1/rcv1_only_class_name_no_template.json
VAL_DESCRIPTIONS=../../class_descrs/rcv1/rcv1_only_class_name_no_template.json
TEST_DESCRIPTIONS=../../class_descrs/rcv1/rcv1_only_class_name_no_template.json
